...
async def send_text_message(
    to: str, body: str, wa: WhatsApp = Depends(get_async_wa_client)
) -> MessageResponse:
    """
...
async def send_audio_message(
    to: str, media_path: UploadFile, wa: WhatsApp = Depends(get_async_wa_client)
) -> MessageResponse:
    """
...
async def send_document_message(
    ...
    result = await service.send_document_message(
        to, document, filename, content_type, caption
    )
    return MessageResponse.model_validate(result, from_attributes=True)
...
async def mark_message_as_read(
    message_id: str, wa: WhatsApp = Depends(get_async_wa_client)
) -> bool:
    """
